...
function timePacker(dom,e) {
    ...
    html += '<div class="timePacker">';
        html += '<div class="timePacker-hours" style="display: block;">';
            ...
            html += '<div class="timePacker-content">';
                html += '<ul>';
                    ...
                    while (i < 24)
                    {
						// 注意补零情况,现在为有补零的状态,如果设置为不用补零,那么请将var text注释 从if判断开始的源码部分为text的变量直接更改为i即可.
                        var text = i < 10 ? "0" + i : i;
        ...
        html += '<div class="timePacker-minutes" style="display: none;">';
            html += '<div class="timePacker-title"><span>分钟</span><span class="timePacker-back-hours" title="返回小时选择"><img src="../../image/back.png"/> </span></div>';
            html += '<div class="timePacker-content">';
                html += '<ul>';
                    var m = 0;
                    while (m < 60)
